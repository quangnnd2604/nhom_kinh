                    ...
                    <div class="searchbox-input">
                        ...
                        <div class="custom-select-dropdown">
                            ...
                            <div class="select-input">
                                <input type="text" name="activities_location" readonly placeholder="<?php echo esc_html__('Select Location', 'triprex-core') ?>">
            ...
            <div class="col-xl-4 col-md-6 d-flex justify-content-center divider">
                <div class="single-search-box">
                    ...
                    <div class="searchbox-input">
                        ...
                        <div class="custom-select-dropdown">
                            <div class="select-input">
                                <input type="text" readonly name="activities_type" placeholder="<?php echo esc_html__('Select Activity Type', 'triprex-core') ?>">
                                <i class="bi bi-chevron-down"></i>
                            </div>
