...
if (class_exists('CSF')) {
  /*-------------------------------------------------------
	   ** Hotel Archive Page Options
   --------------------------------------------------------*/
  CSF::createSection($prefix, array(
    'id'    => 'hotel',
    'title' => esc_html__('Hotel', 'triprex-core'),
    'icon'  => 'fa fa-h-square'
  ));

  CSF::createSection($prefix, array(
    'parent' => 'hotel', // The slug id of the parent section
    'title'  => esc_html__('Archive Page', 'triprex-core'),
    'icon'   => 'fa fa-list-alt',
    'fields' => array(
      array(
        'type'    => 'subheading',
        'content' => '<h3>' . esc_html__('Hotel Archive Page Options', 'triprex-core') . '</h3>',
      ),
      array(
        'id'    => 'hotel_archive_num_of_post',
        'type'  => 'number',
      ...
      array(
        'id'      => 'hotel_archive_sidebar_enable',
  ...
  CSF::createSection($prefix, array(
    ...
    'fields' => array(
      array(
        'type'    => 'subheading',
        'content' => '<h3>' . esc_html__('Hotel Details Page Options', 'triprex-core') . '</h3>',
      ),
      array(
        'type'    => 'subheading',
      ...
      array(
        'id'      => 'hotel_booking_form_heading_title',
        'type'    => 'text',
        'title'   => 'Title',
        'desc'    => wp_kses(__('Write the booking form<mark>heading title</mark> here', 'triprex-core'),  wp_kses_allowed_html('post')),
        'default' => wp_kses(__('Book Your Room', 'triprex-core'),  wp_kses_allowed_html('post')),
      ),
      array(
        'id'      => 'hotel_booking_form_heading_desc',
        'type'    => 'textarea',
        'title'   => 'Description',
        'desc'    => wp_kses(__('Write the booking form<mark>heading description</mark>here', 'triprex-core'),  wp_kses_allowed_html('post')),
        'default' => wp_kses(__('Reserve your ideal Room early for a hassle-free trip; secure comfort and convenience!', 'triprex-core'),  wp_kses_allowed_html('post')),
      ),
      array(
        'id'      => 'hotel_booking_form_shortcode',
        'type'    => 'textarea',
        'title'   => esc_html__('Add Your Booking Form Shortcode', 'triprex-core'),
        'default' => '[contact-form-7 id="f779c58" title="hotel inquiry form"]',
      ),
      // Banner Card
      array(
        'type'    => 'subheading',
      ...
      array(
        'id'         => 'hotel_banner_card_show_hide',
        'type'       => 'switcher',
      ...
      array(
        ...
        'dependency' => array(
          array('hotel_banner_card_show_hide',  '==', '1'),
        ),
      ),
      ...
      array(
        'id'         => 'hotel_bnr_crd_contact_info_show',
        'type'       => 'switcher',
      ...
      array(
        'id'      => 'hotel_bnr_crd_contact_info',
        'type'    => 'repeater',
        'title'   => esc_html__('Contact Information', 'triprex-core'),
        'dependency' => array(
          array('hotel_banner_card_show_hide', '==', 'true'),
          array('hotel_bnr_crd_contact_info_show', '==', '1'),
        ),
        'fields' => array(
          array(
            'id'      => 'contact_h_bnr_type',
            'type'    => 'radio',
          ...
          array(
            'id'         => 'phone_h_bnr_icon_svg',
            'type'       => 'media',
            'title'      => esc_html__('Icon (SVG) for Phone', 'triprex-core'),
            'dependency' => array('contact_h_bnr_type', '==', 'phone'),
          ),
          array(
            'id'         => 'phone_h_bnr_info_text',
            'type'       => 'text',
          ...
          array(
            'id'         => 'email_h_bnr_icon_svg',
            'type'       => 'media',
            'title'      => esc_html__('Icon (SVG) for Email', 'triprex-core'),
            'dependency' => array('contact_h_bnr_type', '==', 'email'),
          ),
          array(
            'id'         => 'email_h_bnr_info_text',
            'type'       => 'text',
          ...
          array(
            'id'         => 'custom_h_bnr_icon_svg',
            'type'       => 'media',
            'title'      => esc_html__('Icon (SVG) for Others', 'triprex-core'),
            'dependency' => array('contact_h_bnr_type', '==', 'others'),
          ),
          array(
            'id'         => 'custom_h_bnr_info_txt',
            'type'       => 'text',
            'title'      => esc_html__('Custom Info Text', 'triprex-core'),
            'dependency' => array('contact_h_bnr_type', '==', 'others'),
          ),
          array(
            'id'         => 'custom_h_bnr_info',
            'type'       => 'text',
        ...
        'default' => array(
          array(
            'contact_h_bnr_type' => 'phone',
            'phone_h_bnr_icon_svg' => array(
            ...
            'phone_h_bnr_info_text' => esc_html__('To More Inquiry', 'triprex-core'),
            'phone_h_bnr_info' => esc_html__('+91 656 786 53', 'triprex-core'),

            'email_h_bnr_icon_svg' => array(
            ...
            'email_h_bnr_info_text' => esc_html__('Email:', 'triprex-core'),
            'email_h_bnr_info' => esc_html__('info@example.com', 'triprex-core'),
          ),
        ),
      ),
    )
