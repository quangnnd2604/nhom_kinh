		...
		?>
			<div class="col is-nav-selected first">
				...
				foreach ($attachment_ids as $attachment_id) {
					...
					echo apply_filters('woocommerce_single_product_image_thumbnail_html', sprintf('<div class="col"><a>%s</a><p>%s</p></div>', $image, $image_alt), $attachment_id, $post->ID, $image_class);
